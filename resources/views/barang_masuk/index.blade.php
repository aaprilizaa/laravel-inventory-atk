...
<body class="bg-slate-50 flex min-h-screen text-slate-800">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 hidden md:block">
        ...
        <nav class="px-4 space-y-1">
            ...
            <a href="{{ route('barang_masuk.index') }}" class="flex items-center gap-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-xl font-semibold">
                📥 Barang Masuk
            </a>
            @endif
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-6 py-4">
                            <div class="flex flex-col">
                                <span class="font-bold text-slate-700">{{ $d->barang->nama }}</span>
                                <span class="text-xs text-slate-400">Kode: {{ $d->barang->kode }}</span>
                            </div>
                        </td>
                        <td class="px-6 py-4">
